...
@ViewScoped
@ManagedBean
public class TopicosMaisVisualizadosBean extends GenericBean {
	...
	@PostConstruct
	public void init() {
		topicos = relatorioServiceBean.buscarTopicosMaisVisualizados(new ArrayList<Long>());
	}

	public void gerarPDF() {
		FacesContext context = FacesContext.getCurrentInstance();
		String reportUrlReal = ConstantesRelatorio.TOPICOS_MAIS_VISUALIZADOS;
		Map<String, Object> params = new HashMap<String, Object>();
		params = GenericBean.adicionaImagemCabecalho(params, context);

		params.put("titulo", "Tópicos mais visualizados");
