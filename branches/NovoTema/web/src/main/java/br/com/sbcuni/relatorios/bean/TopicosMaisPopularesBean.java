...
@ViewScoped
@ManagedBean
public class TopicosMaisPopularesBean extends GenericBean {
	...
	@PostConstruct
	public void init() {
		topicos = relatorioServiceBean.buscarTopicosMaisBemAvaliados();
	}

	public void gerarPDF() {
		FacesContext context = FacesContext.getCurrentInstance();
		String reportUrlReal = ConstantesRelatorio.TOPICOS_MAIS_POPULARES;
		Map<String, Object> params = new HashMap<String, Object>();
		params = GenericBean.adicionaImagemCabecalho(params, context);

		
		params.put("titulo", "Tópicos mais populares");
