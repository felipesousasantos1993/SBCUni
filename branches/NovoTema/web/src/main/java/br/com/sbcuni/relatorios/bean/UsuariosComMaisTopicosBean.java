...
@ViewScoped
@ManagedBean
public class UsuariosComMaisTopicosBean extends GenericBean {
	...
	@PostConstruct
	public void init() {
		usuarios = relatorioServiceBean.buscarUsuariosComMaisTopicos();
	}

	public void gerarPDF() {
		FacesContext context = FacesContext.getCurrentInstance();
		String reportUrlReal = ConstantesRelatorio.USUARIOS_COM_MAIS_TOPICOS;
		Map<String, Object> params = new HashMap<String, Object>();
		params = GenericBean.adicionaImagemCabecalho(params, context);
		
		params.put("titulo", "Usuários com Mais Tópicos Criados");
