...
@ViewScoped
@ManagedBean
public class TopicosMaisComentadosBean extends GenericBean {
	...
	@PostConstruct
	public void init() {
		topicos = relatorioServiceBean.buscarTopicosMaisComentados();
	}

	public void gerarPDF() {
		FacesContext context = FacesContext.getCurrentInstance();
		String reportUrlReal = ConstantesRelatorio.TOPICOS_MAIS_COMENTADOS;
		Map<String, Object> params = new HashMap<String, Object>();
		params = GenericBean.adicionaImagemCabecalho(params, context);

		params.put("titulo", "Tópicos mais comentados");
