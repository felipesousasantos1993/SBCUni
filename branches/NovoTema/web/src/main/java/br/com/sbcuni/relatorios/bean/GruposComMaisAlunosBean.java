...
@ViewScoped
@ManagedBean
public class GruposComMaisAlunosBean extends GenericBean {
	...
	@PostConstruct
	public void init() {
		grupos = relatorioServiceBean.buscarGruposComMaisAlunos();
	}

	public void gerarPDF() {
		FacesContext context = FacesContext.getCurrentInstance();
		String reportUrlReal = ConstantesRelatorio.GRUPOS_COM_MAIS_ALUNOS;
		Map<String, Object> params = new HashMap<String, Object>();
		params = GenericBean.adicionaImagemCabecalho(params, context);

		params.put("titulo", "Grupos de Estudo com Mais Alunos");
